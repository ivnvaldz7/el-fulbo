...
- naming documental alineado a `feat-004-admin-dashboard`
- fase 3 de `feat-004-admin-dashboard` completada
- implementado: mutaciones reales de resolución + endpoint `/api/admin-tasks/resolve` + acciones desde `/admin-tasks`
