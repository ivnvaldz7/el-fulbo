...
const BASE_DATA: ExportGroupData = {
  group: { id: '22222222-2222-2222-2222-222222222221', name: 'Los Pibes', default_modality: 'F5', created_at: '2026-01-01' },
  roster: [
    { id: '33333333-3333-3333-3333-333333333331', user_id: '44444444-4444-4444-4444-444444444441', display_name: 'Messi', primary_position: 'DEL', stats_status: 'approved', stats: {}, is_phantom: false, is_expelled: false, joined_at: '2026-01-01', archived_at: null },
  ...
  events: [
    { id: '11111111-1111-1111-1111-111111111111', modality: 'F5', field_name: 'La Boquita', scheduled_at: '2026-05-01T20:00:00Z', status: 'played', team_a_score: 3, team_b_score: 2 },
  ],
  attendances: [
    { event_id: '11111111-1111-1111-1111-111111111111', player_id: '33333333-3333-3333-3333-333333333331', status: 'going', checked_in: true },
  ],
  participations: [
    { event_id: '11111111-1111-1111-1111-111111111111', player_id: '33333333-3333-3333-3333-333333333331', team: 'A', assigned_position: 'DEL' },
  ],
  statChangeLogs: [
    { id: 'l1', player_id: '33333333-3333-3333-3333-333333333331', changed_by_user_id: '44444444-4444-4444-4444-444444444441', requested_by_user_id: 'u2', before_stats: {}, after_stats: {}, reason: 'MVP', created_at: '2026-05-01' },
  ],
  revisionRequests: [
    { id: 'r1', player_id: '33333333-3333-3333-3333-333333333331', user_id: 'u2', status: 'pending' },
  ],
...
describe('anonymizeData', () => {
  it('replaces user_id with sequential anonymous ids', () => {
    const result = anonymizeData(BASE_DATA, '44444444-4444-4444-4444-444444444441', true, 'Messi');
  ...
  it('hides identity for owner (not admin)', () => {
    const result = anonymizeData(BASE_DATA, '44444444-4444-4444-4444-444444444441', false, 'Messi');
  ...
  it('handles null user_id gracefully', () => {
    ...
    const result = anonymizeData(data, '44444444-4444-4444-4444-444444444441', true, 'Messi');
